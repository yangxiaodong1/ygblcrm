...
class UserProfile(AbstractBaseUser,PermissionsMixin):
    ...
    objects = UserProfileManager()  # objects 这个地方是写死的

    stu_account = models.ForeignKey("Customer",verbose_name="关联学员账号",blank=True,null=True,help_text='只有学员报名后才可以以创建账户')
    USERNAME_FIELD = 'email' # 指定一下
    REQUIRED_FIELDS = ['name'] # 必要字段是名字
